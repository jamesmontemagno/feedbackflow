...
public class UsageTrackingService : IUsageTrackingService
{
    ...
    public UsageTrackingService(IAccountLimitsService limitsService, IUserAccountTableService userAccountTable, FeedbackFunctions.Middleware.AuthenticationMiddleware authMiddleware)
    {
