    ...
    private EmailTemplate GenerateWeeklyDigestTemplate(string recipientName, List<ReportModel> reports)
    {
        ...
        var reportsList = string.Join("", reports.Select(r => $@"
            <div style='border-left: 4px solid #667eea; padding-left: 15px; margin: 15px 0;'>
                ...
                <a href='https://www.feedbackflow.app/?source=email&id={r.Id}' style='color: #667eea; text-decoration: none;'>View Report →</a>
            </div>"));
...
<body>
    ...
    <div class='content'>
        ...
        <p style='margin-top: 30px;'>
            <a href='https://www.feedbackflow.app/reports' style='display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: 600;'>View All Reports</a>
        </p>
    </div>
    <div class='footer'>
        <p>Generated by <strong>FeedbackFlow</strong> 🥰</p>
...
{string.Join("\n", reports.Select(r => $"• {r.Source} Report (Generated: {r.GeneratedAt:MMM dd, yyyy}) - https://www.feedbackflow.app/?source=email&id={r.Id}"))}

View all reports: https://www.feedbackflow.app/reports
