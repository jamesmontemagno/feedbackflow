...
public class AdminReportConfigFunctions
{
    ...
    public async Task<HttpResponseData> UpdateAdminReportConfigAsync(
        [HttpTrigger(AuthorizationLevel.Function, "put", Route = "admin-report-configs/{id}")] HttpRequestData req,
        string id)
    {
        try
        {
    ...
    public async Task<HttpResponseData> DeleteAdminReportConfigAsync(
        [HttpTrigger(AuthorizationLevel.Function, "delete", Route = "admin-report-configs/{id}")] HttpRequestData req,
        string id)
    {
        try
        {
