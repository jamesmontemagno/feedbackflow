...
public class ReportCacheFunctions
{
    ...
    public async Task<HttpResponseData> RefreshCache(
        [HttpTrigger(AuthorizationLevel.Function, "get", Route = "cache/refresh")] HttpRequestData req)
    {
    ...
    public async Task<HttpResponseData> ClearCache(
        [HttpTrigger(AuthorizationLevel.Function, "get", Route = "cache/clear")] HttpRequestData req)
    {
